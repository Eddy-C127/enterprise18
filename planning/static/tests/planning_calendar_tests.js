...
QUnit.module("Planning.planning_calendar_tests", ({ beforeEach }) => {
    ...
    QUnit.test("planning calendar view: copy previous week", async function (assert) {
        ...
        await click(target.querySelector(".o_control_panel_main_buttons .o_button_copy_previous_week"));
        ...
        await click(target.querySelector(".o_control_panel_main_buttons .o_button_send_all"));
