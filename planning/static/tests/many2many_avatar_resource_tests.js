...
QUnit.module(
     ...
     */
         ...
         */
            ...
            [this.data.employeePublicMarieId, this.data.employeePublicPierreId] = pyEnv[
                "hr.employee.public"
            ].create([
                {
                    name: "Marie",
    ...
    () => {
        QUnit.test("many2many_avatar_resource widget in form view", async function (assert) {
            ...
            await click(
                document.querySelector(".many2many_tags_avatar_field_container .o_tag i.fa-wrench")
            );
            ...
            await click(
                document.querySelectorAll(
                    ".many2many_tags_avatar_field_container .o_tag i.fa-wrench"
                )[1]
            );
            ...
            await click(
                document.querySelector(".many2many_tags_avatar_field_container .o_tag img")
            );
            ...
            await click(
                document.querySelectorAll(".many2many_tags_avatar_field_container .o_tag img")[1]
            );
