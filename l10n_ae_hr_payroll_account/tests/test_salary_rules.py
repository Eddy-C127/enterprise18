...
class TestPayslipValidation(TestPayslipValidationCommon):
    ...
    def test_payslip_1(self):
        ...
        payslip_results = {'BASIC': 40000.0, 'HOUALLOW': 400.0, 'TRAALLOW': 220.0, 'OTALLOW': 100.0, 'EOSP': 0.0, 'GROSS': 40720.0, 'NET': 40720.0}
    ...
    def test_payslip_2(self):
        ...
        payslip_results = {'BASIC': 40000.0, 'HOUALLOW': 400.0, 'TRAALLOW': 220.0, 'OTALLOW': 100.0, 'SALARY_ARREARS': 1000.0, 'OTHER_EARNINGS': 2000.0, 'EOSP': 0.0, 'GROSS': 43720.0, 'SALARY_DEDUCTIONS': -500.0, 'OTHER_DEDUCTIONS': -200.0, 'NET': 43020.0}
        self._validate_payslip(payslip, payslip_results)
