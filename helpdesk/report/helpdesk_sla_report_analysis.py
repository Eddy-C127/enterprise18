...
class HelpdeskSLAReport(models.Model):
    ...
    sla_exceeded_hours = fields.Integer("Working Hours to Reach SLA", aggregator='avg', readonly=True, help="Day to reach the stage of the SLA, without taking the working calendar into account")
