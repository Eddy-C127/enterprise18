...
class ResCompany(models.Model):
    ...
    def _l10n_ch_generate_swissdec_demo_data(self):
        ...
        self.env['hr.salary.attachment'].create([
            # TF01
            {'description': 'Salaire horaire', 'monthly_amount': 160.0, 'total_amount': 320.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 170.0, 'total_amount': 170.0, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf01'].id)]},
            ...
            # TF02
            {'description': 'Salaire horaire', 'monthly_amount': 150.0, 'total_amount': 150.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 70.0, 'total_amount': 140.0, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 142.0, 'total_amount': 142.0, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 100.0, 'total_amount': 100.0, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 162.0, 'total_amount': 162.0, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 50.0, 'total_amount': 50.0, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 162.0, 'total_amount': 162.0, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 150.0, 'total_amount': 150.0, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 50.0, 'total_amount': 50.0, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 40.0, 'total_amount': 40.0, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 40.0, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 8, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Salaire à la leçon', 'monthly_amount': 20.0, 'total_amount': 20.0, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 90, 'total_amount': 90, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 50, 'total_amount': 50, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 25, 'total_amount': 25, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 35, 'total_amount': 35, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 40, 'total_amount': 40, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 35, 'total_amount': 35, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 105, 'total_amount': 105, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 89, 'total_amount': 89, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 81, 'total_amount': 81, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 95, 'total_amount': 95, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            ...
            {'description': 'Perte de gain RHT/ITP (SH)', 'monthly_amount': 3000, 'total_amount': 6000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_indemnite_perte_gain').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Indemnité de chômage', 'monthly_amount': 2200, 'total_amount': 4400, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_indemnite_chomage').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            {'description': 'Délai de carence RHT/ITP', 'monthly_amount': 200, 'total_amount': 400, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_delai_carence_rht_itp').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf02'].id)]},
            ...
            # TF03
            {'description': 'Indemnité spéciale', 'monthly_amount': 3200, 'total_amount': 6400, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf03'].id)]},
            ...
            # TF04
            {'description': '14ème salaire', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_14th_month').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf04'].id)]},
            ...
            # TF05
            {'description': 'Indemnité de dimanche', 'monthly_amount': 6000, 'total_amount': 12000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_sunday_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf05'].id)]},
            ...
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 10000, 'total_amount': 20000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf05'].id)]},
            ...
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 20000, 'total_amount': 40000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf06'].id)]},
            ...
            # TF 07
            {'description': 'Heures supplémentaires après le départ', 'monthly_amount': 15000, 'total_amount': 15000, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_overtime_after_departure').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf07'].id)]},
            ...
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 9500, 'total_amount': 9500, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf07'].id)]},
            ...
            # TF08
            {'description': 'Salaire horaire', 'monthly_amount': 170.0, 'total_amount': 2040.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 350.0, 'total_amount': 350.0, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 25, 'total_amount': 25, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 35, 'total_amount': 35, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 40, 'total_amount': 40, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 35, 'total_amount': 35, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 105, 'total_amount': 105, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 89, 'total_amount': 89, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 81, 'total_amount': 81, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 44, 'total_amount': 44, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 95, 'total_amount': 95, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité travail par équipes', 'monthly_amount': 44, 'total_amount': 44, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_team_work').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            {'description': 'Indemnité de dimanche', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_sunday_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf08'].id)]},
            ...
            {'description': 'Indemnité spéciale', 'monthly_amount': 35000, 'total_amount': 35000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            ...
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 32000, 'total_amount': 32000, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf09'].id)]},
            # TF10
            {'description': 'Heures supplémentaires 125%', 'monthly_amount': 1200, 'total_amount': 1200, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_overtime_125').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 31000, 'total_amount': 31000, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 7000, 'total_amount': 7000, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            ...
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 1800, 'total_amount': 1800, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Correction indemnité de tiers', 'monthly_amount': 4500, 'total_amount': 4500, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_third_party_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Déduction RHT/ITP (SM)', 'monthly_amount': 3000, 'total_amount': 3000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_ded_rht_itp').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Versement salaire après décès', 'monthly_amount': 6400, 'total_amount': 12800, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_dead_alw').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Indemnité de chômage', 'monthly_amount': 2200, 'total_amount': 2200, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_indemnite_chomage').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            {'description': 'Délai de carence RHT/ITP', 'monthly_amount': 200, 'total_amount': 200, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_delai_carence_rht_itp').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf10'].id)]},
            ...
            # TF11
            {'description': 'Honoraires', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_fee_ch').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Honoraires', 'monthly_amount': 15000, 'total_amount': 15000, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_fee_ch').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Indemnité de résidence', 'monthly_amount': 500, 'total_amount': 7000, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_house_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            ...
            {'description': 'Indemnité spéciale', 'monthly_amount': 3400, 'total_amount': 3400, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 1200, 'total_amount': 1200, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Prestation en capital à caractère de prévoyance', 'monthly_amount': 50000, 'total_amount': 50000, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_pension_capital').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            ...
            {'description': 'Réduction loyer logement locatif', 'monthly_amount': 1200, 'total_amount': 16800, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_rental_housing').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Actions de collaborateurs', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_action_collab').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Actions de collaborateurs', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_action_collab').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            ...
            {'description': 'Correction prestations en nature', 'monthly_amount': 1200, 'total_amount': 16800, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_bik_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 250, 'total_amount': 500, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 20250, 'total_amount': 20250, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 250, 'total_amount': 500, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 5, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 19750, 'total_amount': 19750, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 250, 'total_amount': 2000, 'date_start': date(2022, 7, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf11'].id)]},
            # TF12
            ...
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 7000, 'total_amount': 7000, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'description': 'Options de collaborateurs', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_optcollab').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'description': 'Perfectionnement (certificat de salaire)', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_improv').id, 'is_refund': False},
            ...
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 6500, 'total_amount': 6500, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'description': 'Correction indemnité de tiers', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_third_party_correction').id, 'is_refund': True},
            ...
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 850, 'total_amount': 6800, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 9, 30), 'description': 'Correction prestations en nature', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_bik_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 7000, 'total_amount': 7000, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'description': 'Correction avantage en argent', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf12'].id)], 'monthly_amount': 1000, 'total_amount': 8000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 9, 30), 'description': 'Frais effectifs expatriés', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_effective_expatriate_costs').id, 'is_refund': False},
            ...
            # TF13
            {'description': 'Indemnité de résidence', 'monthly_amount': 200, 'total_amount': 2800, 'date_start': date(2022, 1, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_house_allowance').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Heures supplémentaires', 'monthly_amount': 180, 'total_amount': 180, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_overtime100').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Heures supplémentaires', 'monthly_amount': 300, 'total_amount': 300, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_overtime100').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Heures supplémentaires', 'monthly_amount': 80, 'total_amount': 80, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_overtime100').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            {'description': 'Heures supplémentaires', 'monthly_amount': 250, 'total_amount': 250, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_overtime100').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf13'].id)]},
            ...
            # TF14
            {'description': 'Salaire horaire', 'monthly_amount': 75.0, 'total_amount': 75.0, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 11, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2021, 12, 1), 'date_end': date(2021, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 115.0, 'total_amount': 115.0, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 160.0, 'total_amount': 160.0, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 95.0, 'total_amount': 95.0, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 140.0, 'total_amount': 280.0, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 6, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 125.0, 'total_amount': 125.0, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 170.0, 'total_amount': 170.0, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Options de collaborateurs', 'monthly_amount': 10000, 'total_amount': 10000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_optcollab').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            {'description': 'Correction avantage en argent', 'monthly_amount': 10000, 'total_amount': 10000, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': True, 'employee_ids': [(4, mapped_employees['employee_tf14'].id)]},
            ...
            # TF15
            {'description': 'Salaire à la leçon', 'monthly_amount': 21, 'total_amount': 21, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_lesson').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf15'].id)]},
            ...
            # TF16
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 9458.35, 'total_amount': 9458.35, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 11, 30), 'description': 'Honoraires', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_fee_ch').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 8895, 'total_amount': 8895, 'date_start': date(2021, 12, 1), 'date_end': date(2021, 12, 31), 'description': 'Honoraires', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_fee_ch').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 14350.6, 'total_amount': 14350.6, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'description': 'Honoraires', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_fee_ch').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 10214.45, 'total_amount': 10214.45, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'description': 'Honoraires', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_fee_ch').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 3000, 'total_amount': 3000, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 11, 30), 'description': 'Indemnité spéciale', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 5000, 'total_amount': 5000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'description': 'Indemnité spéciale', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 4000, 'total_amount': 4000, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'description': 'Indemnité spéciale', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False},
            ...
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 150, 'total_amount': 300, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 12, 31), 'description': '3ème pilier b payé par employeur', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_thirdpillb').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 150, 'total_amount': 300, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'description': '3ème pilier b payé par employeur', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_thirdpillb').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 350, 'total_amount': 700, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 12, 31), 'description': '3ème pilier a payé par employeur', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_thirdpilla').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 350, 'total_amount': 700, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'description': '3ème pilier a payé par employeur', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_thirdpilla').id, 'is_refund': False},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2021, 11, 1), 'date_end': date(2021, 11, 30), 'description': 'Correction avantage en argent', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 750, 'total_amount': 750, 'date_start': date(2021, 12, 1), 'date_end': date(2021, 12, 31), 'description': 'Correction avantage en argent', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': True},
            {'employee_ids': [(4, mapped_employees['employee_tf16'].id)], 'monthly_amount': 500, 'total_amount': 1000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 3, 31), 'description': 'Correction avantage en argent', 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_cash_correction').id, 'is_refund': True},
            ...
            {'employee_ids': [(4, mapped_employees['employee_tf17'].id)], 'monthly_amount': 2000, 'total_amount': 2000 * 1, 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_holiday_bonus').id, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'description': 'Bonus'},
             ...
             # TF18
            {'description': 'Salaire horaire', 'monthly_amount': 35.0, 'total_amount': 280.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 8, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 75, 'total_amount': 75, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 62, 'total_amount': 62, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 53, 'total_amount': 53, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 71, 'total_amount': 71, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 35, 'total_amount': 70, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf18'].id)]},
            ...
            # TF19
            # TF20
            {'description': 'Indemnité de départ (soumis AVS)', 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_sevpay').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf20'].id)]},
            # TF21
            {'description': 'Indemnité de départ soumis à l AVS', 'employee_ids': [(4, mapped_employees['employee_tf21'].id)], 'monthly_amount': 500, 'total_amount': 500 * 1, 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_sevpay').id, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31)},

            # TF22
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 125.0, 'total_amount': 125.0, 'date_start': date(2022, 3, 1), 'date_end': date(2022, 3, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 135.0, 'total_amount': 135.0, 'date_start': date(2022, 4, 1), 'date_end': date(2022, 4, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 115.0, 'total_amount': 115.0, 'date_start': date(2022, 5, 1), 'date_end': date(2022, 5, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 100.0, 'total_amount': 100.0, 'date_start': date(2022, 6, 1), 'date_end': date(2022, 6, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 140.0, 'total_amount': 140.0, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 115.0, 'total_amount': 115.0, 'date_start': date(2022, 8, 1), 'date_end': date(2022, 8, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2022, 9, 1), 'date_end': date(2022, 9, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 90.0, 'total_amount': 90.0, 'date_start': date(2022, 10, 1), 'date_end': date(2022, 10, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 120.0, 'total_amount': 120.0, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 130.0, 'total_amount': 130.0, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 40.0, 'total_amount': 40.0, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            {'description': 'Salaire horaire', 'monthly_amount': 96.0, 'total_amount': 96.0, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_hourly').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf22'].id)]},
            ...
            # TF28
            {'description': 'Heures supplémentaires après le départ', 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_overtime_after_departure').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf28'].id)]},
            ...
            {'description': "Paiement de la prime l'année précédente", 'monthly_amount': 15000, 'total_amount': 15000, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_prevybonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf28'].id)]},
            {'description': "Prime pour proposition d'amélioration", 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_impbonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf28'].id)]},
            # TF29
            {'description': 'Correction des salaires', 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_salary_correction').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf29'].id)]},
            {'description': 'Heures supplémentaires après le départ', 'monthly_amount': 2000, 'total_amount': 2000, 'date_start': date(2023, 1, 1), 'date_end': date(2023, 1, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_overtime_after_departure').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf29'].id)]},
            ...
            {'description': "Paiement de la prime l'année précédente", 'monthly_amount': 15000, 'total_amount': 15000, 'date_start': date(2023, 2, 1), 'date_end': date(2023, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_prevybonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf29'].id)]},
            {'description': "Prime pour proposition d'amélioration", 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_impbonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf29'].id)]},
            # TF30
            {'description': 'Paiement des vacances', 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2022, 11, 1), 'date_end': date(2022, 11, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_vacalw').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf30'].id)]},
            {'description': 'Droits de participation imposables', 'monthly_amount': 5500, 'total_amount': 22000, 'date_start': date(2022, 1, 1), 'date_end': date(2022, 4, 30), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_taxpfee').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf30'].id)]},
            # TF31
            # TF32
            ...
            {'description': 'Paiement pour Allocation pour enfant', 'monthly_amount': 690, 'total_amount': 690, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_childalwpay').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf33'].id)]},
            # TF34
            ...
            {'description': 'Paiement pour Allocation pour enfant', 'monthly_amount': 600, 'total_amount': 600, 'date_start': date(2022, 7, 1), 'date_end': date(2022, 7, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_childalwpay').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf34'].id)]},
            # TF35
            {'description': "Paiement de la prime l'année précédente", 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_prevybonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf35'].id)]},
            ...
            # TF36
            {'description': "Paiement de la prime l'année précédente", 'monthly_amount': 30000, 'total_amount': 30000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_prevybonus').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf36'].id)]},
            ...
            # TF40
            {'description': 'Indemnité pour service de piquet', 'monthly_amount': 30500, 'total_amount': 30500, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_oncallalw').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 20000, 'total_amount': 20000, 'date_start': date(2022, 2, 1), 'date_end': date(2022, 2, 28), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
            {'description': 'Indemnité spéciale', 'monthly_amount': 500, 'total_amount': 500, 'date_start': date(2022, 12, 1), 'date_end': date(2022, 12, 31), 'deduction_type_id': self.env.ref('l10n_ch_hr_payroll.hr_salary_attachment_type_special_indemnity').id, 'is_refund': False, 'employee_ids': [(4, mapped_employees['employee_tf40'].id)]},
