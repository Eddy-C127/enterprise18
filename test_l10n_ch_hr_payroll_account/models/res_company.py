...
class ResCompany(models.Model):
    ...
    def _l10n_ch_generate_swissdec_demo_data(self):
        ...
        mapped_payslips['payslip_tf40_2022_12'] = self._l10n_ch_generate_swissdec_demo_payslip(mapped_contracts['contract_tf40_04'], date(2022, 12, 1), date(2022, 12, 31), thirteen_month=True)
