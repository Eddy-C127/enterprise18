    ...
    def test_01_termination_unused_leaves(self):
        ...
        self._test_payslip(
            ...
            expected_lines=[
                ...
                ("WITHHOLD.TOTAL", normal_withholding + expected_withhold + 52),
                ("NET", 2584.61 + expected_gross + (normal_withholding + expected_withhold + 52)),
                ("SUPER", 284),
            ],
    ...
    def test_13_termination_unused_leaves(self):
        ...
        self._test_payslip(
            ...
            expected_lines=[
                ...
                ("MEDICARE", -156.0),
                ("ETP.LEAVE.WITHHOLD", expected_withhold),
                ("WITHHOLD.TOTAL", normal_withholding + expected_withhold - 156.0),
                ("NET", 323.08 + expected_gross + (normal_withholding + expected_withhold - 156.0)),
                ("SUPER", 35.54),
            ],
            payslip_date_from=contract.date_end.replace(day=1),
            payslip_date_to=contract.date_end,
    ...
    def test_23_termination_unused_leaves(self):
        ...
        self._test_payslip(
            ...
            expected_lines=[
                ...
                ("MEDICARE", 12),
                ("ETP.LEAVE.WITHHOLD", expected_withhold),
                ("WITHHOLD.TOTAL", normal_withholding + expected_withhold + 12),
                ("NET", 600.1 + expected_gross + (normal_withholding + expected_withhold + 12)),
                ("SUPER", 66.01),
            ],
