...
class AccountMove(models.Model):
    ...
    def _close_tax_period(self, report, options):
        ...
        self._close_tax_period_reminder(report, options)


    def _close_tax_period_reminder(self, report, options):
        ...
        activity_type = self.env.ref('account_reports.mail_activity_type_tax_report_to_be_sent')
