...
export class MrpDisplay extends Component {
    ...
    setup() {
        ...
        onWillStart(async () => {
            ...
            if (this.state.activeWorkcenter && (!this.state.workcenters.length || (!(this.state.activeWorkcenter in this.state.workcenters.map((wc) => wc.id)) && this.state.activeWorkcenter != -1))) {
