...
class HrContract(models.Model):
    ...
    l10n_ch_is_predefined_category = fields.Selection([
        ('HE', 'Scale for administrators'),
        ('ME', 'Scale for employee contributions'),
        ('NO', 'Scale for people not subject to withholding tax (Corrective value)'),  # YTI TODO: Probably to remove right ?
        ('SF', 'Scale for French cross-border workers according to the special agreement with France'),
    ], string="IS Predefined Category", help="Des barèmes fixes sont appliqués pour l'impôt à la source retenu sur les honoraires des administrateurs (art. 93 LIFD) et certaines participations de collaborateur (art. 97a LIFD). Pour ces impôts, aucun enfant n'est pris en compte et un seul taux en %% est appliqué. À cela s'ajoutent des catégories prédéfinies pour les annonces rectificatives et pour l'annonce des salaires bruts des frontaliers français pour lesquels l'accord spécial entre les cantons BE, BS, BL, JU, NE, SO, VD et VS et la France s'applique.")
