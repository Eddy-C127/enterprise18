...
import {
    ...
    getSynchedStatus,
} from "@documents_spreadsheet/../tests/legacy/spreadsheet_test_utils";
...
import {
    joinSession,
    leaveSession,
} from "@spreadsheet_edition/../tests/legacy/utils/collaborative_helpers";
...
QUnit.module(
    ...
    function () {
        ...
        QUnit.test("collaborative session client has the user id", async function (assert) {
            ...
            assert.strictEqual(localClient.userId, user.userId);
        });
